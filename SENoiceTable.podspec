...
Pod::Spec.new do |s|
  s.name             = 'SENoiceTable'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SENoiceTable.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/SENoiceTable'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Sahand Edrisian' => 'sedrisian@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/SENoiceTable.git', :tag => s.version.to_s }
